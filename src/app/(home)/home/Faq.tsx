  ...
  return (
    ...
    >
      <Maxwidth tw="py-20 px-6 lg:(p-[6.25rem])">
        ...
        <div tw="flex flex-col gap-16 lg:(flex-row justify-between items-center)">
          <Image src={question} alt="faq" tw="max-lg:(mx-auto max-w-[203px])" />

          <div tw="flex flex-col gap-6 lg:(gap-[2.62rem] max-w-[40.4rem])">
            <Paragraph>
              Whether you're striving to manage your time more effectively,
              deepen your spiritual connection, or engage with a community that
              shares your values, Acco-Rifaaq offers a comprehensive solution.{' '}
              <br />

...
const Hero = () => {
  return (
    <section tw="bg-primary text-white bg-primary bg-center bg-cover bg-[linear-gradient(180deg,_rgba(10,_22,_54,_0.89)_51.57%,_rgba(15,_32,_77,_0.77)_100%)]">
      <Maxwidth tw="flex flex-col gap-[4.31rem] text-center items-center pt-12 pb-16 px-6 lg:(flex-row text-left justify-between py-16 px-[6.25rem] gap-8) xl:(gap-[2.31rem])">
        <div tw="max-w-[325px] mx-auto sm:(max-w-[90%]) lg:(max-w-max)">

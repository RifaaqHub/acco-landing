...
const headingVariants: Record<HeadingVariant, TwStyle> = {
  ...
  h2: tw`text-[2.5rem] leading-[3.25rem] md:(text-[3rem] leading-[3.5rem]) lg:(text-[3.5rem] leading-[4rem])`,
  h3: tw`text-[1.75rem] leading-[2.275rem] md:(text-[1.85rem] leading-[2.4rem]) lg:(text-[2rem] leading-[2.75rem])`,
  h4: tw`text-[1.25rem] leading-[1.75rem] md:(text-[1.85rem] leading-[2.4rem])`,
}

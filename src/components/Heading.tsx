...
const headingVariants: Record<HeadingVariant, TwStyle> = {
  h1: tw`text-[2.5rem] leading-[2.75rem] md:(text-[3rem] leading-[4rem]) lg:(text-[3.5rem] leading-[5rem]) xl:(text-[4.5rem] leading-[6.6rem])`,
  ...
  h4: tw`text-[1.25rem] leading-[1.75rem] md:(text-[1.85rem] leading-[2.4rem]) xl:(text-[2rem] leading-[2.75rem])`,
}
